...
def main():
    ...
    if success:
        ...
        print("\\nNext steps:")
        print("1. Test manually: uv run python -c 'from classifier import predict; print(predict(\"test\"))'")
        print("2. Run integration: uv run python integration.py")
        print("3. Test competition: cd ../../DM-i-AI-2025/emergency-healthcare-rag && python example.py")
    else:
