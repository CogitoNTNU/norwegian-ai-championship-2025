...
class QueryRewriteRAG:
    ...
    def run(self, question: str, reference_contexts: List[str]) -> Dict[str, Union[str, List[str]]]:
        ...
        rewrite_prompt_template = """You are an AI assistant tasked with reformulating user queries to improve retrieval in a RAG system.
        ...
        rewritten_question = query_rewrite_chain.invoke({"question": question})
