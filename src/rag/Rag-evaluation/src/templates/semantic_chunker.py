...
class SemanticChunkerRAG:
    ...
    def run(self, question: str, reference_contexts: List[str]) -> Dict[str, Union[str, List[str]]]:
        ...
        text_splitter = SemanticChunker(
            self.embeddings, breakpoint_threshold_type="percentile", breakpoint_threshold_amount=90
        )
        ...
        rag_chain = (
            ...
            .assign(answer=prompt | RunnableLambda(self.llm.langchain_llm.invoke) | StrOutputParser())
            .pick(["answer", "context"])
        )
