...
class DocumentChunker:
    ...
    def _create_chunk(self, words: List[str], chunk_idx: int, file_path: Path, topic_name: str, topic_id: int) -> Dict:
    ...
    def chunk_document(self, file_path: Path) -> List[Dict]:
        ...
        while start_idx < len(words):
            ...
            chunk = self._create_chunk(chunk_words, chunk_idx, file_path, topic_name, topic_id)
            chunks.append(chunk)
