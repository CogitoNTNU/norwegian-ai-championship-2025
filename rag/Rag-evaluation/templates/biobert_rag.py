...
class BiobertRAG:
    ...
    def _load_and_embed_data(self):
        ...
        if all(
            ...
            if os.path.exists(metadata_path):
                ...
                print("✅ Loaded optimized BioBERT indexes:")
                print(
    ...
    def hybrid_retrieval(
        ...
        semantic_results = [
            {"document": self.documents[idx], "score": distances[0][i]}
        ...
        bm25_results = [
            ...
            for idx, score in zip(bm25_results_indices, bm25_scores)
        ]
        ...
        initial_results = [
            item["doc"] for item in sorted_results[: k * 2]
